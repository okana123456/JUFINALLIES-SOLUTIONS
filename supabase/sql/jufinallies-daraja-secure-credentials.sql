-- Run once in the Jufinallies Supabase SQL Editor before deploying register-daraja.
...
insert into public.jufinallies_daraja_credentials (business_id, consumer_key, consumer_secret)
...
where exists (
  select 1
  from public.jufinallies_daraja_credentials c
